    ...
    <div class="col-lg-12 layout-spacing layout-top-spacing">
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <form class="" wire:submit="addProduct">
                    <div class="row mb-4">
                        <div class="col-sm-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-4">
                            <label>Upload Gambar Thumbnail Toko</label>
                        ...
                        <div class="col-sm-8">
                            <label class="mb-0">Upload Gambar Toko</label>
                    ...
                    <button type="submit" class="btn btn-primary _effect--ripple waves-effect waves-light " wire:loading.remove>Tambah Produk</button>
                </form>
            </div>
        </div>
    </div>
