    ...
    <div class="col-lg-12 layout-spacing layout-top-spacing">
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <form class="" wire:submit="addCategory">
                    <div class="row mb-4">
                        <div class="col-sm-4">
                    ...
                    <button type="submit" class="btn btn-primary _effect--ripple waves-effect waves-light " wire:loading.remove>Tambah Kategori</button>
                </form>
            </div>
        </div>
    </div>
