<div>
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/category/list-category">Kategori</a></li>
    ...
    <div class="col-lg-12 layout-spacing layout-top-spacing">
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <form class="" wire:submit="editCategory">
                    <div class="row mb-4">
                        <div class="col-sm-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input wire:ignore wire:model="icon" type="file" class="form-control-file" @error('icon') has-error @enderror" placeholder="image" onchange="previewSketsa('.imageDemo1', this.files[0])">
                            <div wire:ignore class="col-md mt-3">
                                <input type="hidden" name="oldImage" value="{{ $category->icon }}">
                                @if ($category->icon)
                                    <img src="/assets/category/{{ $category->icon }}" class="img-preview img-fluid mb-3 col-sm-5 d-block imageDemo1">   
                                @endif
                            </div>
                    ...
                    <button type="submit" class="btn btn-primary _effect--ripple waves-effect waves-light " wire:loading.remove>Edit Kategori</button>
                </form>
            </div>
        </div>
    </div>
