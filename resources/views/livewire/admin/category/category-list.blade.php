                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td><img src="/assets/category/{{ $category->icon }} " alt="" style="max-width: 80px" class="img-fluid mb-1"></td>
                                <td>{{ $category->name }}</td>
                                <td>{{ $category->status }}</td>
                                <td class="text-center">
                                    <div class="action-btns">
                                        <a href="{{ route('categoryEdit', $category->id) }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
